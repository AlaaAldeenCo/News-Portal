...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{setSidebarActive(['admin.category.index'])}}"><a class="nav-link" href="{{ route('admin.category.index') }}"><i class="far fa-square"></i>
            ...
            <li class="dropdown {{setSidebarActive(['admin.news.*', 'admin.pending.news'])}}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{setSidebarActive(['admin.pending.news'])}}"><a class="nav-link" href="{{ route('admin.pending.news') }}">{{__('All Pending News')}}</a></li>
                </ul>
            </li>
            ...
            <li class="{{setSidebarActive(['admin.social-count.*', 'admin.contact-message.*', 'admin.social-count.index'])}}"><a class="nav-link" href="{{ route('admin.social-count.index') }}"><i class="far fa-square"></i>
                    <span>{{__('Social Count')}}</span></a></li>
            <li class="{{setSidebarActive(['admin.contact-message.index'])}}"><a class="nav-link" href="{{ route('admin.contact-message.index') }}"><i class="far fa-square"></i>
                    <span>{{__('Contact Messages')}}</span>
                @if ($unreadMessages > 0)
                <i class="badge bg-danger" style="color: #fff">{{$unreadMessages}}</i>
                @endif
                </a></li>
            <li class="{{setSidebarActive(['admin.home-section-setting.index'])}}"><a class="nav-link" href="{{ route('admin.home-section-setting.index') }}"><i class="far fa-square"></i>
                    <span>{{__('Home Section Setting')}}</span></a></li>
            <li class="{{setSidebarActive(['admin.language.*', 'admin.language.index'])}}"><a class="nav-link" href="{{ route('admin.language.index') }}"><i class="far fa-square"></i>
                    <span>{{__('Language')}}</span></a></li>
            <li class="{{setSidebarActive(['admin.subscribers.*', 'admin.subscribers.index'])}}"><a class="nav-link" href="{{ route('admin.subscribers.index') }}"><i class="far fa-square"></i>
                    ...
                    <li class="dropdown {{setSidebarActive(['admin.role-users.*', 'admin.role.*'])}}">
                        ...
                        <ul class="dropdown-menu">
                            <li class="{{setSidebarActive(['admin.role-users.*'])}}"><a class="nav-link" href="{{ route('admin.role-users.index') }}">{{__('Users Roles')}}</a></li>
